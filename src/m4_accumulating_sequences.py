...
def run_test_make_less_simple_string():
    ...
    # Test 2
    expected = '208'
    actual = make_less_simple_string(208, 208)
    print('Expected', expected)
    print('Actual', actual)
...
def rectangles_from_circles(circles):
    ...
    rects=[]
    for k in circles:
        r1=rg.Rectangle(rg.Point(k.center.x+k.radius,k.center.y+k.radius),rg.Point(k.center.x-k.radius,k.center.y-k.radius))
        rects=rects+[r1]
    return rects
